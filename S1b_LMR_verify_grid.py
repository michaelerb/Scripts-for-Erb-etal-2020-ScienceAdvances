...
# ---
#nexp = 'LMR_gisgpcc_ccms4_LMRdbv0.4.0_NorthAmerica_exclude_tas'
#nexp = 'LMR_gisgpcc_ccms4_LMRdbv0.4.0_NorthAmerica_only_tas'
#nexp = 'LMR_gisgpcc_ccms4_LMRdbv0.4.0_annualPSM_NorthAmerica_exclude_tas'
nexp = 'LMR_gisgpcc_ccms4_LMRdbv0.4.0_annualPSM_NorthAmerica_only_tas'
...
datadir_output = '/projects/pd_lab/data/LMR/archive_output'


# Directory where reanalysis data can be found
#datadir_reanl = '/home/disk/kalman3/rtardif/LMR/data/model'
datadir_reanl = '/projects/pd_lab/data/LMR/data/model'
...
datadir_calib = '/projects/pd_lab/data/LMR/data/analyses'
